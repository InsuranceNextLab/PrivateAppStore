angular.module('starter.services', [])
  .factory('fireBaseData', function($firebaseArray) {
    var ref = new Firebase("https://inextappdistribution.firebaseio.com/"),
      refAndroid = new Firebase("https://inextappdistribution.firebaseio.com/Android"),
      refIOS = new Firebase("https://inextappdistribution.firebaseio.com/IOS"),
      refWear = new Firebase("https://inextappdistribution.firebaseio.com/Wear"),
      refWebs = new Firebase("https://inextappdistribution.firebaseio.com/Web");
    return {
      refAllApps: function() {
